...
const Cricket = () => (
  <GamePageTemplate
    ...
    description="Bet on live cricket matches at YOLO365 — IPL, T20 World Cup, BBL, PSL with best odds, in-play markets, instant UPI deposit & 5-minute withdrawal."
    keywords="online cricket betting India, IPL betting, live cricket betting site, cricket betting ID WhatsApp, T20 World Cup odds, cricket exchange India"
    h1="Online Cricket Betting on YOLO365"
    intro="YOLO365 is India's #1 online cricket betting exchange. Bet live on IPL, T20 World Cup, BBL, PSL, and every international series — with the sharpest odds, in-play markets every ball, and a verified cricket betting ID delivered on WhatsApp in 60 seconds."
    imageAlt="Online cricket betting on yolo365games.live with IPL live odds"
    highlights={[
      { title: "Best IPL odds", desc: "Match-winner, top batsman, top bowler, over/under, and 50+ in-play markets every over." },
    ...
    strategy={
      <>
        ...
        <p>For <strong>IPL betting</strong>, focus on toss + first-innings totals on dew-affected venues like Chennai and Mumbai. For Test cricket, session markets (runs in next 10 overs) offer better edge than full match-winner. In T20 World Cup matches, top-batsman markets on openers consistently beat random selection.</p>
        <p>Use our <a href="/blog/cricket-betting-bankroll-management-india" className="text-gold underline">bankroll management guide</a> and the <a href="/blog/ipl-betting-tips-yolo365" className="text-gold underline">IPL tips</a> blog to sharpen your edge before every match.</p>
      </>
    }
    faqs={[
